  ...
  return (
    <TouchableOpacity onPress={onPress} activeOpacity={0.5}>
      <Wrapper
        style={[
          styles.roundWrapper,
          { backgroundColor: bgColor ?? colors.white20 },
          style,
        ]}>
        {children}
      </Wrapper>
    ...
    <TouchableOpacity
      ...
      {customIcon ? (
        ...
        <Icon
          ...
          size={iconSize ? iconSize : totalSize(1.8)}
          color={tintColor ? tintColor : colors.appBgColor1}
          iconStyle={iconStyle}
        />
      )}
      <View
...
export const Custom = ({ icon, size, animation, duration, color, onPress, containerStyle, style }) => {
  const defaulSize = totalSize(5);
  return (
    <View animation={animation} duration={duration} style={{ ...containerStyle }}>
